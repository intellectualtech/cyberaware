<?php
// admin/edit_user.php - Edit Existing Employee Page
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error_messages)) {
        try {
            ...
            if ($stmt->rowCount() > 0) {
                $error_messages[] = 'Username or email address is already in use by another account.';
            }
        } catch (Exception $e) {
    ...
    if (empty($error_messages)) {
        try {
            ...
            $success_message = "User '{$full_name}' updated successfully.";
            ...
            $error_messages[] = 'Failed to update user. Please try again.';
        }
    }
}
?>
...
<head>
    ...
    <title>Edit User - CyberAware Admin</title>
...
<body>
    ...
    <main class="main-content">
        <h2 class="page-title">Edit User: <?= htmlspecialchars($user['full_name'] ?? 'Unknown') ?></h2>
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <div class="form-group checkbox">
                    <input type="checkbox" id="is_active" name="is_active" <?= $is_active ? 'checked' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="form-note">Only fill if you want to change the password.</div>
                </div>
