...
.badge{display:inline-block;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:700;background:var(--ol);color:var(--orange);}
.btn-group{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:20px;}
.btn{display:inline-flex;align-items:center;gap:8px;padding:10px 16px;border-radius:10px;text-decoration:none;font-weight:600;font-size:14px;border:none;cursor:pointer;transition:.2s;}
...
body.dark-mode .badge{background:rgba(255,140,66,.15);color:var(--orange);}
...
<div class="layout" id="mainLayout">
    <aside class="sidebar" id="sidebarPanel">
        ...
        <a href="compliance-snapshot.php" class="nav-item active"><i class="fas fa-check-circle"></i> Compliance Snapshot</a>
    ...
    <main class="main">
        ...
        <div class="kpi-grid">
            <div class="kpi-card">
                ...
                <div class="kpi-value"><?= $total_trainees ?></div>
                <div class="kpi-desc">Active employees</div>
            </div>
            <div class="kpi-card">
                <div class="kpi-label">Avg Completion</div>
                <div class="kpi-value"><?= $avg_completion ?>%</div>
                <div class="kpi-desc">Course completion rate</div>
            </div>
            <div class="kpi-card">
                <div class="kpi-label">Avg Score</div>
                <div class="kpi-value"><?= $avg_score ?>%</div>
                <div class="kpi-desc">Average test score</div>
            </div>
            <div class="kpi-card">
                <div class="kpi-label">Active Campaigns</div>
                <div class="kpi-value"><?= $active_campaigns ?></div>
                <div class="kpi-desc">Live simulations</div>
            </div>
        </div>

        <div class="btn-group">
            <a href="export-report.php" class="btn btn-primary">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-users"></i> User Compliance Details</h3>
            </div>
            <?php if (empty($users)): ?>
                <p style="color:#aaa;text-align:center;padding:40px 0;"><i class="fas fa-user-slash" style="font-size:36px;margin-bottom:12px;display:block;"></i>No trainee data available</p>
            <?php else: ?>
            <table>
                <thead>
                    <tr>
                    ...
                    <?php foreach ($users as $user): ?>
                        ...
                        <tr>
                            <td>
                                ...
                                <small style="color:#888;"><?= htmlspecialchars($user['email'] ?: 'no-email') ?></small>
                            </td>
